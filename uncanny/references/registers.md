...
- **Institutional agency is legitimate.** "OpenSky will provide", "the Authority requires", "the contract provides for": organisations are the actors in this register. The false-agency rule targets abstractions ("the roadmap demands", "the transformation journey delivers"), not institutions.
